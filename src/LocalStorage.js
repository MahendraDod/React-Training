...
class TODOwithLocalStorage extends React.Component {
  constructor(props) {
    super(props);

    const storedArr = JSON.parse(localStorage.getItem('todoArr')) || [];
  ...
  componentDidUpdate() {
    localStorage.setItem('todoArr', JSON.stringify(this.state.arr));
  }
